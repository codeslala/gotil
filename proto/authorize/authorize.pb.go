...
var file_authorize_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x1a, 0x1b, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d,
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2f, 0x0a, 0x07, 0x52, 0x65, 0x71,
	...
	,
}
...
var file_authorize_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_authorize_proto_goTypes = []interface{}{
	(*Request)(nil),     // 0: authorize.Request
	(*empty.Empty)(nil), // 1: google.protobuf.Empty
}
var file_authorize_proto_depIdxs = []int32{
	0, // 0: authorize.Authorize.Authorize:input_type -> authorize.Request
	1, // 1: authorize.Authorize.Authorize:output_type -> google.protobuf.Empty
...
type AuthorizeClient interface {
	Authorize(ctx context.Context, in *Request, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *authorizeClient) Authorize(ctx context.Context, in *Request, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/authorize.Authorize/Authorize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthorizeServer interface {
	Authorize(context.Context, *Request) (*empty.Empty, error)
}
...
func (*UnimplementedAuthorizeServer) Authorize(context.Context, *Request) (*empty.Empty, error) {
...
func _Authorize_Authorize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/authorize.Authorize/Authorize",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizeServer).Authorize(ctx, req.(*Request))
	}
